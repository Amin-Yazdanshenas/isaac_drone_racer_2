...
class CTBRAction(ActionTerm):
    ...
    def __init__(self, cfg: "CTBRActionCfg", env: "ManagerBasedRLEnv") -> None:
        ...
        # Resolve gains_path against repo root if relative
        if os.path.isabs(cfg.gains_path):
            gains_path = cfg.gains_path
        else:
            repo_root = os.path.abspath(os.path.join(os.path.dirname(__file__), "..", "..", ".."))
            gains_path = os.path.join(repo_root, cfg.gains_path)
    ...
    def apply_actions(self) -> None:
        ...
        # PD on rate error (correct form — track err derivative directly).
...
class CTBRActionCfg(ActionTermCfg):
    ...
    gains_path: str = "tasks/drone_racer/configs/ctbr_gains.yaml"
